...
**現状: v0.1 MVP(親 issue #1 の子 #2〜#9)を実装完了し、`v0.0.1` としてリリース済み。**
scanner・設定 loader・rule engine・baseline・reporter・公開 API / CLI・parity 検証まで
main に入っている。[DESIGN.ja.md](DESIGN.ja.md) が設計の正典。
