...
- v0.3: `go test` helper、reporter 拡充(dot / HTML)、folder scope、moreUnstable、reachable edge provenance filter、`internal/engine` と `cruiser` の `ViolationKind` 二重定義の整理(公開 API と JSON の文字列値は維持)
