...
| reachable | Go 再解釈 | forbidden の from file から target package への推移到達と、entrypoint package 群から到達できない package の検出に使う |
...
- v0.2: required + reachable、numberOfDependents 系
